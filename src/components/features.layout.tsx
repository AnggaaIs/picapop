    ...
    <>
      <FeaturesItem
        ...
        icon={<svg
          ...
          className="w-5 h-5 text-emerald-600 lg:w-6 lg:h-6 lucide lucide-camera-icon lucide-camera"
          fill="none"
        >
      ...
      <FeaturesItem
        icon={
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="w-5 h-5 text-emerald-600 lg:w-6 lg:h-6 lucide lucide-palette-icon lucide-palette"
          >
      ...
      <FeaturesItem
        icon={
          <svg
            className="w-5 h-5 text-emerald-600 lg:w-6 lg:h-6"
            fill="currentColor"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      <FeaturesItem
        icon={
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="w-5 h-5 text-emerald-600 lg:w-6 lg:h-6 lucide lucide-settings-icon lucide-settings "
          >
      ...
      <FeaturesItem
        icon={
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="w-5 h-5 text-emerald-600 lg:w-6 lg:h-6 lucide lucide-save-all-icon lucide-save-all"
          >
      ...
      <FeaturesItem
        icon={
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="w-5 h-5 text-emerald-600 lg:w-6 lg:h-6 lucide lucide-brain-icon lucide-brain"
          >
