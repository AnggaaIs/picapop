    ...
    <section className="min-h-[100vh] h-full">
      <div className="flex items-center justify-center px-4 py-8 mx-auto sm:py-16 lg:py-24 lg:px-6 h-full">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <Link href="/" className="inline-flex text-white focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4">Back to Homepage</Link>
        </div>
      </div>
    </section>
  )
